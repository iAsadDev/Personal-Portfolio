...
const Projects = () => {
  const projects = [
    {
      title: "KitchenPro - Premium Kitchen Products Store with Admin Panel & Blog",
      description: "KitchenPro is a full-stack e-commerce website built using the MERN stack (MongoDB, Express.js, React.js, Node.js). It features a user-friendly interface where customers can browse and purchase high-quality kitchen products. The website includes Product Listings – Filter, search, and view detailed product pages.Shopping Cart & Checkout – . Admin Panel – Manage products, orders, users, and blog posts.Blog Section – Articles on cooking tips, kitchen hacks.",
    ...
    {
      title: " BurgerHub - Modern Burger Shop Website with Menu & Blog",
      description: "BurgerHub is a fully responsive, high-performance fast food website built with React.js, Vite, and Tailwind CSS, designed to deliver an exceptional user experience for burger enthusiasts. The frontend features a dynamic menu system with category filtering (burgers, fries, drinks), detailed product modals with customization options, and a blog section for company updates and food articles.",
    ...
    },
    {
      ...
      github: "https://github.com/iAsadDev/Portfolio-Website.git",
